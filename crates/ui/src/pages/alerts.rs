...
use crate::api::{delete, get_json, patch_json, post_json};
...
use crate::pages::{BTN_GHOST, BTN_PRIMARY, CTRL_INPUT};
use crate::types::{
...
type ChannelsRes = Resource<Result<ChannelsList, crate::api::ApiError>>;
type AlertsRes = Resource<Result<AlertsList, crate::api::ApiError>>;
